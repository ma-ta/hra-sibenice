...
- **[All-in-one řešení (soubor ZIP)](//github.com/ma-ta/hra-sibenice/releases/download/v0.0.5/sibenice_0.0.5_bin.zip)**
...
![Šibenice 0.0.5 - Hra](/res/screenshots/hra.png)

Herní statistiky:

![Šibenice 0.0.5 - Statistiky](/res/screenshots/kronika.png)

Informace o verzi (MS-DOS 6.22):

![Šibenice 0.0.5 - MS-DOS](res/screenshots/prepinace-dos.png)
